...
* `join_multiple_stages()` - joins a list of multiple stages corresponding to one variable

* `partition_stages()` - joins stages corresponding to one variable according to the specified partition

* `stages_bhc_plot()`- simultaneously runs the Backward Hill-Climbing algorithm 
